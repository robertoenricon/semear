...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'name.required' => 'Informe um usuário.',
            'name.min' => 'O usuário deve ter pelo menos 3 caracteres.',
            'name.max' => 'O usuário deve ter no máximo 255 caracteres.',
            'name.unique' => 'Este usuário já está em uso. Escolha outro.',
